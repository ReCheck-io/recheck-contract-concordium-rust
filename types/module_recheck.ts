...
export const moduleReference: SDK.ModuleReference.Type = /*#__PURE__*/ SDK.ModuleReference.fromHexString('3e3c617c89c1ea454df444f6c5fcece12c2f100646b9957e304b72f93caf24d5');
/** Name of the smart contract supported by this client. */
export const contractName: SDK.ContractName.Type = /*#__PURE__*/ SDK.ContractName.fromStringUnchecked('recheck');
 ...
 */
export async function create(grpcClient: SDK.ConcordiumGRPCClient, contractAddress: SDK.ContractAddress.Type, blockHash?: SDK.BlockHash.Type): Promise<RecheckContract> {
 ...
 * @returns {RecheckContract}
 */
export function createUnchecked(grpcClient: SDK.ConcordiumGRPCClient, contractAddress: SDK.ContractAddress.Type): RecheckContract {
    const genericContract = new SDK.Contract(grpcClient, contractAddress, contractName);
    return new RecheckContract(
        grpcClient,
        contractAddress,
 ...
 */
export function checkOnChain(contractClient: RecheckContract, blockHash?: SDK.BlockHash.Type): Promise<void> {
...
const base64CreateSubRecordWithExtras2ParameterSchema = 'FAAGAAAACQAAAHJlY29yZF9pZBYCEAAAAHBhcmVudF9yZWNvcmRfaWQWAgUAAAB0cmFpbBYCDwAAAHRyYWlsX3NpZ25hdHVyZRYCBgAAAGV4dHJhMBYCBgAAAGV4dHJhMRYC';
 ...
 */
function createCreateSubRecordWithExtras2ParameterSchemaJson(parameter: CreateSubRecordWithExtras2Parameter): CreateSubRecordWithExtras2ParameterSchemaJson {
 ...
 */
export function createCreateSubRecordWithExtras2Parameter(parameter: CreateSubRecordWithExtras2Parameter): SDK.Parameter.Type {
 ...
 */
export function createCreateSubRecordWithExtras2ParameterWebWallet(parameter: CreateSubRecordWithExtras2Parameter) {
    return {
 ...
 */
export function sendCreateSubRecordWithExtras2(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: CreateSubRecordWithExtras2Parameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
 ...
 */
export function dryRunCreateSubRecordWithExtras2(contractClient: RecheckContract, parameter: CreateSubRecordWithExtras2Parameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
...
export type ErrorMessageCreateSubRecordWithExtras2 = { type: 'ParseError'} | { type: 'Unauthorized'} | { type: 'ContractError'} | { type: 'Custom', content: string };
 ...
 */
export function parseErrorMessageCreateSubRecordWithExtras2(invokeResult: SDK.InvokeContractResult): ErrorMessageCreateSubRecordWithExtras2 | undefined {
    ...
    const schemaJson = <{'ParseError' : [] } | {'Unauthorized' : [] } | {'ContractError' : [] } | {'Custom' : [string] }>SDK.ReturnValue.parseWithSchemaTypeBase64(invokeResult.returnValue, 'FQQAAAAKAAAAUGFyc2VFcnJvcgIMAAAAVW5hdXRob3JpemVkAg0AAABDb250cmFjdEVycm9yAgYAAABDdXN0b20BAQAAABYC');
    let match7: { type: 'ParseError'} | { type: 'Unauthorized'} | { type: 'ContractError'} | { type: 'Custom', content: string };
...
const base64CreateSubRecordParameterSchema = 'FAAEAAAACQAAAHJlY29yZF9pZBYCEAAAAHBhcmVudF9yZWNvcmRfaWQWAgUAAAB0cmFpbBYCDwAAAHRyYWlsX3NpZ25hdHVyZRYC';
 ...
 */
function createCreateSubRecordParameterSchemaJson(parameter: CreateSubRecordParameter): CreateSubRecordParameterSchemaJson {
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createCreateSubRecordParameter(parameter: CreateSubRecordParameter): SDK.Parameter.Type {
 ...
 * @returns The smart contract parameter support by the WebWallet.
 */
export function createCreateSubRecordParameterWebWallet(parameter: CreateSubRecordParameter) {
    return {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendCreateSubRecord(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: CreateSubRecordParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunCreateSubRecord(contractClient: RecheckContract, parameter: CreateSubRecordParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('createSubRecord'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
...
export type ErrorMessageCreateSubRecord = { type: 'ParseError'} | { type: 'Unauthorized'} | { type: 'ContractError'} | { type: 'Custom', content: string };
 ...
 */
export function parseErrorMessageCreateSubRecord(invokeResult: SDK.InvokeContractResult): ErrorMessageCreateSubRecord | undefined {
    if (invokeResult.tag !== 'failure' || invokeResult.reason.tag !== 'RejectedReceive') {
        return undefined;
    }
    ...
    const schemaJson = <{'ParseError' : [] } | {'Unauthorized' : [] } | {'ContractError' : [] } | {'Custom' : [string] }>SDK.ReturnValue.parseWithSchemaTypeBase64(invokeResult.returnValue, 'FQQAAAAKAAAAUGFyc2VFcnJvcgIMAAAAVW5hdXRob3JpemVkAg0AAABDb250cmFjdEVycm9yAgYAAABDdXN0b20BAQAAABYC');
    let match17: { type: 'ParseError'} | { type: 'Unauthorized'} | { type: 'ContractError'} | { type: 'Custom', content: string };
    if ('ParseError' in schemaJson) {
       match17 = {
           type: 'ParseError',
       };
...
const base64CreateRecordParameterSchema = 'FAADAAAACQAAAHJlY29yZF9pZBYCBQAAAHRyYWlsFgIPAAAAdHJhaWxfc2lnbmF0dXJlFgI=';
 ...
 */
function createCreateRecordParameterSchemaJson(parameter: CreateRecordParameter): CreateRecordParameterSchemaJson {
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createCreateRecordParameter(parameter: CreateRecordParameter): SDK.Parameter.Type {
 ...
 * @returns The smart contract parameter support by the WebWallet.
 */
export function createCreateRecordParameterWebWallet(parameter: CreateRecordParameter) {
    return {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendCreateRecord(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: CreateRecordParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunCreateRecord(contractClient: RecheckContract, parameter: CreateRecordParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('createRecord'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
...
export type ErrorMessageCreateRecord = { type: 'ParseError'} | { type: 'Unauthorized'} | { type: 'ContractError'} | { type: 'Custom', content: string };
 ...
 */
export function parseErrorMessageCreateRecord(invokeResult: SDK.InvokeContractResult): ErrorMessageCreateRecord | undefined {
    if (invokeResult.tag !== 'failure' || invokeResult.reason.tag !== 'RejectedReceive') {
        return undefined;
    }
    ...
    const schemaJson = <{'ParseError' : [] } | {'Unauthorized' : [] } | {'ContractError' : [] } | {'Custom' : [string] }>SDK.ReturnValue.parseWithSchemaTypeBase64(invokeResult.returnValue, 'FQQAAAAKAAAAUGFyc2VFcnJvcgIMAAAAVW5hdXRob3JpemVkAg0AAABDb250cmFjdEVycm9yAgYAAABDdXN0b20BAQAAABYC');
    let match26: { type: 'ParseError'} | { type: 'Unauthorized'} | { type: 'ContractError'} | { type: 'Custom', content: string };
    if ('ParseError' in schemaJson) {
       match26 = {
           type: 'ParseError',
       };
 ...
 */
function createRecordsParameterSchemaJson(parameter: RecordsParameter): RecordsParameterSchemaJson {
    return parameter;
}
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createRecordsParameter(parameter: RecordsParameter): SDK.Parameter.Type {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendRecords(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: RecordsParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunRecords(contractClient: RecheckContract, parameter: RecordsParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('records'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
...
export type ReturnValueRecords = {
    record_id: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number],
    parent_record_id: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number],
    trail: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number],
    trail_signature: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number],
    creator: { type: 'Account', content: SDK.AccountAddress.Type } | { type: 'Contract', content: SDK.ContractAddress.Type },
 ...
 */
export function parseReturnValueRecords(invokeResult: SDK.InvokeContractResult): ReturnValueRecords | undefined {
    ...
    trail: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number],
    trail_signature: [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number],
    creator: {'Account' : [SDK.AccountAddress.SchemaValue] } | {'Contract' : [SDK.ContractAddress.SchemaValue] },
...
const base64SubRecordParameterSchema = 'FAACAAAADQAAAHN1Yl9yZWNvcmRfaWQWAgUAAABpbmRleAU=';
 ...
 */
function createSubRecordParameterSchemaJson(parameter: SubRecordParameter): SubRecordParameterSchemaJson {
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createSubRecordParameter(parameter: SubRecordParameter): SDK.Parameter.Type {
 ...
 * @returns The smart contract parameter support by the WebWallet.
 */
export function createSubRecordParameterWebWallet(parameter: SubRecordParameter) {
    return {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendSubRecord(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: SubRecordParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunSubRecord(contractClient: RecheckContract, parameter: SubRecordParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('subRecord'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
 ...
 */
export function parseReturnValueSubRecord(invokeResult: SDK.InvokeContractResult): ReturnValueSubRecord | undefined {
    if (invokeResult.tag !== 'success') {
        return undefined;
    }
 ...
 */
function createVerifyTrailParameterSchemaJson(parameter: VerifyTrailParameter): VerifyTrailParameterSchemaJson {
    return parameter;
}
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createVerifyTrailParameter(parameter: VerifyTrailParameter): SDK.Parameter.Type {
 ...
 * @returns The smart contract parameter support by the WebWallet.
 */
export function createVerifyTrailParameterWebWallet(parameter: VerifyTrailParameter) {
    return {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendVerifyTrail(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: VerifyTrailParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunVerifyTrail(contractClient: RecheckContract, parameter: VerifyTrailParameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('verifyTrail'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
 ...
 */
export function parseReturnValueVerifyTrail(invokeResult: SDK.InvokeContractResult): ReturnValueVerifyTrail | undefined {
    if (invokeResult.tag !== 'success') {
        return undefined;
    }
    ...
    let match92: { type: 'Account', content: SDK.AccountAddress.Type } | { type: 'Contract', content: SDK.ContractAddress.Type };
 ...
 */
function createVerifyExtra0ParameterSchemaJson(parameter: VerifyExtra0Parameter): VerifyExtra0ParameterSchemaJson {
    return parameter;
}
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createVerifyExtra0Parameter(parameter: VerifyExtra0Parameter): SDK.Parameter.Type {
 ...
 * @returns The smart contract parameter support by the WebWallet.
 */
export function createVerifyExtra0ParameterWebWallet(parameter: VerifyExtra0Parameter) {
    return {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendVerifyExtra0(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: VerifyExtra0Parameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunVerifyExtra0(contractClient: RecheckContract, parameter: VerifyExtra0Parameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('verifyExtra0'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
 ...
 */
export function parseReturnValueVerifyExtra0(invokeResult: SDK.InvokeContractResult): ReturnValueVerifyExtra0 | undefined {
    if (invokeResult.tag !== 'success') {
        return undefined;
    }
    ...
    let match114: { type: 'Account', content: SDK.AccountAddress.Type } | { type: 'Contract', content: SDK.ContractAddress.Type };
    ...
    const contractAddress118 = SDK.ContractAddress.fromSchemaValue(variant117[0]);
       match114 = {
           type: 'Contract',
 ...
 */
function createVerifyExtra1ParameterSchemaJson(parameter: VerifyExtra1Parameter): VerifyExtra1ParameterSchemaJson {
    return parameter;
}
 ...
 * @returns {SDK.Parameter.Type} The smart contract parameter.
 */
export function createVerifyExtra1Parameter(parameter: VerifyExtra1Parameter): SDK.Parameter.Type {
 ...
 * @returns The smart contract parameter support by the WebWallet.
 */
export function createVerifyExtra1ParameterWebWallet(parameter: VerifyExtra1Parameter) {
    return {
 ...
 * @returns {SDK.TransactionHash.Type} Hash of the transaction.
 */
export function sendVerifyExtra1(contractClient: RecheckContract, transactionMetadata: SDK.ContractTransactionMetadata, parameter: VerifyExtra1Parameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
    return contractClient.genericContract.createAndSendUpdateTransaction(
 ...
 * @returns {SDK.InvokeContractResult} The result of invoking the smart contract instance.
 */
export function dryRunVerifyExtra1(contractClient: RecheckContract, parameter: VerifyExtra1Parameter, invokeMetadata: SDK.ContractInvokeMetadata = {}, blockHash?: SDK.BlockHash.Type): Promise<SDK.InvokeContractResult> {
    return contractClient.genericContract.dryRun.invokeMethod(
        SDK.EntrypointName.fromStringUnchecked('verifyExtra1'),
        invokeMetadata,
        SDK.Parameter.toBuffer,
 ...
 */
export function parseReturnValueVerifyExtra1(invokeResult: SDK.InvokeContractResult): ReturnValueVerifyExtra1 | undefined {
    if (invokeResult.tag !== 'success') {
        return undefined;
    }
    ...
    let match136: { type: 'Account', content: SDK.AccountAddress.Type } | { type: 'Contract', content: SDK.ContractAddress.Type };
    ...
    const contractAddress140 = SDK.ContractAddress.fromSchemaValue(variant139[0]);
       match136 = {
           type: 'Contract',
