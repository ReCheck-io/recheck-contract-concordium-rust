 ...
 */
export function instantiateRecheck(moduleClient: ModuleModule, transactionMetadata: SDK.ContractTransactionMetadata, parameter: RecheckParameter, signer: SDK.AccountSigner): Promise<SDK.TransactionHash.Type> {
