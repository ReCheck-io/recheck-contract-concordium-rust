...
exports.instantiateRecheck = exports.getModuleSource = exports.checkOnChain = exports.createUnchecked = exports.create = exports.moduleReference = void 0;
 ...
 */
function instantiateRecheck(moduleClient, transactionMetadata, parameter, signer) {
    return SDK.ModuleClient.createAndSendInitTransaction(moduleClient.internalModuleClient, SDK.ContractName.fromStringUnchecked('recheck'), transactionMetadata, parameter, signer);
}
exports.instantiateRecheck = instantiateRecheck;
